...
//        yield return ShowMessage("Chào bạn, mình là trợ giảng của bài học này");
//        yield return ShowMessage("Sau đây bạn cần làm 2 thử thách nhỏ để hoàn thành bài học");

//        yield return ShowMessage("1. Hãy tạo góc tới = góc phản xạ = 30°");
//        yield return ShowMessage("2. Hãy phản xạ tia qua 2 gương liên tiếp");

//        yield return ShowMessage("OK, chúng ta bắt đầu nhé!");
//    }
...
//    {
//        ShowText("Bạn đã hoàn thành thử thách 1, hãy tiếp tục nhé!");
//    }

//    public void OnTask2Done()
//    {
//        ShowText("Bạn đã hoàn thành thử thách 2");
...
//    {
//        yield return new WaitForSeconds(2f);
//        ShowText("Chúc mừng bạn đã vượt qua 2 thử thách và hoàn thành bài học!");
//    }
...
//        currentCoroutine = StartCoroutine(ShowMessage(msg));
//    }
...
//            // 👉 luôn trước mặt người chơi (1.8m)
//            transform.position = cam.position + cam.forward * 1.8f;
